...
void deplacement_Luffy(int dep,SDL_Rect* luffy,SDL_Rect* regard, char** map){
  ...
  switch(dep){
    case 0: if(luffy->x-2>=0  )//&& map[(((luffy->y+30)/31))][(luffy->x/31)]!='+'/*&& detection_col(map,&luffy,dep)==1*/)
                luffy->x-=2;
            regard->x=TLuffy;
            regard->y=TLuffy;break;
    case 1: if(luffy->x+2<=500-20 )//&& map[(((luffy->y+2)/28))][(luffy->x/28)]!='+'/* && map[(luffy->y/31)][(luffy->x/31)]!='+' */)
                luffy->x+=2;
            regard->x=TLuffy*2;
            regard->y=TLuffy*2;break;
    case 2: if(luffy->y-2>=0 )//&& map[((luffy->y))/32][(luffy->x)/32]!='+' /*&& map[(luffy->y/32)][(luffy->x/32)]!='+'*/)
                luffy->y-=2;
            regard->x=TLuffy*3;
            regard->y=TLuffy*3;break;
    case 3: if(luffy->y+2<=500-20 )//&& map[((luffy->y))/32][((luffy->x-20)/32)]!='+' /*&& map[(luffy->y/32)][(luffy->x/32)]!='+'*/)
                luffy->y+=2;
            regard->x=0;
            regard->y=0;break;
  }
